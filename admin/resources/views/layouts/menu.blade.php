        ...
        <div class="scroll-sidebar">
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li> <a href="{{ route('course') }}" ><span> <i class="fas fa-book-open"></i> </span><span class="hide-menu">Courses</span></a></li>
                    <li> <a href="{{ route('project') }}" ><span> <i class="fas fa-code"></i> </span><span class="hide-menu">Projects</span></a></li>
                    <li> <a href="{{ route('contact') }}" ><span> <i class="fas fa-envelope"></i> </span><span class="hide-menu">Contact</span></a></li>
                </ul>
            </nav>
